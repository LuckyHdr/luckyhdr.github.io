...
for (i=0;i<message.length;i++) {="" xpos[i]="-50;" }="" var="" ypos="new" array()="" 存储每个字符的y位置的数组="" for="" (i="0;i<message.length;i++)" ypos[i]="-50;" 动态生成显示每个字符span标记,="" 使用span来标记字符，是为了方便使用css，并可以自由的绝对定位="" document.write("<span="" id="span&quot;+i+&quot;" class="spanstyle">");
...
document.onmousemove = handlerMM;</message.length;i++)>